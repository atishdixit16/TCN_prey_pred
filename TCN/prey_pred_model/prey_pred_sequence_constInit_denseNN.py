...
os.system('mkdir const_init_denseNN')
...
plt.savefig('const_init_denseNN/prey_pred_losses_constInit.jpg')
...
plt.savefig('const_init_denseNN/prey_pred_prediction_vizualization_constInit.jpg')